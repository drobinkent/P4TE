...
def getPercentileOfArray(dataAsList,percenltileLists):
    for p in percenltileLists:
        print("Percentile: "+str(p)+" value is :"+str(np.percentile(dataAsList, p)))
...
def getAVGFCTByFolder(folderName):
    ...
    shortFlowcount = 0
    largeFlowcount = 0
    shortFlowDurationList=[]
    largeFlowDurationList = []
    # for f in flowTypeVsFCTMap:
    #     if (flowTypeVsSendBytesMap.get(f)[j]<1024*1024):
    #         shortFlowDurationList.append
    #     else:
    #         pass
    for f in flowTypeVsFCTMap:
        j=0
        for j in range(0,len(flowTypeVsSendBytesMap.get(f))):
            if (flowTypeVsSendBytesMap.get(f)[j]<1024*1024):
                ...
                shortFlowTotalBytesMultipledByRetransmission = shortFlowTotalBytesMultipledByRetransmission + flowTypeVsRetransmissionMap.get(f)[j]
                shortFlowcount =  shortFlowcount  + 1
                shortFlowDurationList.append(flowTypeVsFCTMap.get(f)[j])
            else:
                largeFlowTotalBytesSent = largeFlowTotalBytesSent + float(f)
                largeFlowTotalBytesMultipliedByFCT = largeFlowTotalBytesMultipliedByFCT + float(f) * flowTypeVsFCTMap.get(f)[j]
                largeFlowTotalRetransmission = largeFlowTotalRetransmission + flowTypeVsRetransmissionMap.get(f)[j]
                largeFlowcount = largeFlowcount  + 1
                largeFlowDurationList.append(flowTypeVsFCTMap.get(f)[j])
        # weightedFct = np.average(flowTypeVsFCTMap.get(f))
        #
        # totalFlowsize= totalFlowsize+ float(f)
        # totalOfFlowSizeMultipliedByAvgFct = totalOfFlowSizeMultipliedByAvgFct + ( float(f) * weightedFct)
    if (shortFlowTotalBytesSent > 0):
        print("shortFlowcount is "+str(shortFlowcount))
        print("Average FCT for short flow  = ", shortFlowTotalBytesMultipliedByFCT/shortFlowTotalBytesSent)
        # getPercentileOfArray(shortFlowDurationList,[10,25,50,75,90,100])
    if (largeFlowTotalBytesSent > 0):
        print("largeFlowcount is "+str(largeFlowcount))
        print("Average FCT for large flow  = ", largeFlowTotalBytesMultipliedByFCT/largeFlowTotalBytesSent)
        # getPercentileOfArray(largeFlowDurationList,[10,25,50,75,90,100])
    getPercentileOfArray(largeFlowDurationList+shortFlowDurationList,[10,25,50,75,90,100])
    print("Average retransmissions for short flow  = ", shortFlowTotalBytesMultipledByRetransmission/shortFlowcount)
    print("Average retransmissions for large flow  = ", largeFlowTotalRetransmission/largeFlowcount)
...
# print("HULA")
# getAVGFCTByFolder(folderName= "/home/deba/Desktop/P4TE/testAndMeasurement/TEST_RESULTS_DATA_MINING_WORKLOAD_RESULTS/HULA_RESULTS/DataMining_Workload_load_factor_0.8/client-logs-0")
# print("\n\n")
...
# print("HULA")
# getAVGFCTByFolder(folderName= "/home/deba/Desktop/P4TE/testAndMeasurement/TEST_RESULTS_DATA_MINING_WORKLOAD_RESULTS/HULA_RESULTS/DataMining_Workload_load_factor_0.6/client-logs-0")
# print("\n\n")
...
# print("HULA")
# getAVGFCTByFolder(folderName= "/home/deba/Desktop/P4TE/testAndMeasurement/TEST_RESULTS_DATA_MINING_WORKLOAD_RESULTS/HULA_RESULTS/DataMining_Workload_load_factor_0.4/client-logs-0")
# print("\n\n")
...
# print("HULA")
# getAVGFCTByFolder(folderName= "/home/deba/Desktop/P4TE/testAndMeasurement/TEST_RESULTS_DATA_MINING_WORKLOAD_RESULTS/HULA_RESULTS/DataMining_Workload_load_factor_0.2/client-logs-0")
# print("\n\n")
...
# print("HULA")
# getAVGFCTByFolder(folderName= "/home/deba/Desktop/P4TE/testAndMeasurement/TEST_RESULTS_WEB_SEARCH_WORKLOAD_RESULTS/HULA_RESULTS/WebSearchWorkLoad_load_factor_0.8/client-logs-0")
# print("\n\n")
...
# print("HULA")
# getAVGFCTByFolder(folderName= "/home/deba/Desktop/P4TE/testAndMeasurement/TEST_RESULTS_WEB_SEARCH_WORKLOAD_RESULTS/HULA_RESULTS/WebSearchWorkLoad_load_factor_0.6/client-logs-0")
# print("\n\n")
...
# print("HULA")
# getAVGFCTByFolder(folderName= "/home/deba/Desktop/P4TE/testAndMeasurement/TEST_RESULTS_WEB_SEARCH_WORKLOAD_RESULTS/HULA_RESULTS/WebSearchWorkLoad_load_factor_0.4/client-logs-0")
# print("\n\n")
...
# print("HULA")
# getAVGFCTByFolder(folderName= "/home/deba/Desktop/P4TE/testAndMeasurement/TEST_RESULTS_WEB_SEARCH_WORKLOAD_RESULTS/HULA_RESULTS/WebSearchWorkLoad_load_factor_0.2/client-logs-0")
# print("\n\n")
...
# print("HULA")
# getAVGFCTByFolder(folderName= "/home/deba/Desktop/P4TE/testAndMeasurement/TEST_RESULTS_INCAST_WORKLOAD/hula/l2-incast/client-logs-0")
# print("\n\n")
...
#0.6
# print("P4TE With Rate Control ")
# getAVGFCTByFolder(folderName= "/home/p4/P4TE/testAndMeasurement/TEST_RESULTS/WebSearchWorkLoad_load_factor_0.6/client-logs-0")
# print("\n\n")

# print("P4TE Without Rate Control ")
# getAVGFCTByFolder(folderName= "/home/p4/P4TE/testAndMeasurement/TEST_RESULTS/WebSearchWorkLoad_load_factor_0.6/client-logs-1")
# print("\n\n")


# print("Load factor 0.7")
# print("P4TE With Rate Control ")
# getAVGFCTByFolder(folderName= "/home/p4/P4TE/testAndMeasurement/TEST_RESULTS/WebSearchWorkLoad_load_factor_0.7/client-logs-1")
# print("\n\n")

# print("P4TE Without Rate Control ")
# getAVGFCTByFolder(folderName= "/home/p4/P4TE/testAndMeasurement/TEST_RESULTS/P4TE-Without-Rate-Control/WebSearchWorkLoad_load_factor_0.7/client-logs-0")
# print("\n\n")

# print("Load factor 0.8")
# print("P4TE With Rate Control ")
# getAVGFCTByFolder(folderName= "/home/p4/P4TE/testAndMeasurement/TEST_RESULTS/WebSearchWorkLoad_load_factor_0.8/client-logs-0")
# print("\n\n")

# print("P4TE With Rate Control ")
# getAVGFCTByFolder(folderName= "/home/p4/P4TE/testAndMeasurement/TEST_RESULTS/WebSearchWorkLoad_load_factor_0.8/client-logs-1")
# print("\n\n")

# print("P4TE Without Rate Control ")
# getAVGFCTByFolder(folderName= "/home/p4/P4TE/testAndMeasurement/TEST_RESULTS/P4TE-Without-Rate-Control/WebSearchWorkLoad_load_factor_0.8/client-logs-0")
# print("\n\n")


# print("Load factor 0.9")
# print("P4TE With Rate Control ")
# getAVGFCTByFolder(folderName= "/home/p4/P4TE/testAndMeasurement/TEST_RESULTS/WebSearchWorkLoad_load_factor_0.9/client-logs-2")
# print("\n\n")

# print("P4TE Without Rate Control ")
# getAVGFCTByFolder(folderName= "/home/p4/P4TE/testAndMeasurement/TEST_RESULTS/P4TE-Without-Rate-Control/WebSearchWorkLoad_load_factor_0.9/client-logs-0")
# print("\n\n")


# # print("Load factor 1.0")
# # print("P4TE With Rate Control ")
# # getAVGFCTByFolder(folderName= "/home/p4/P4TE/testAndMeasurement/TEST_RESULTS/WebSearchWorkLoad_load_factor_1/client-logs-0")
# # print("\n\n")

# # print("P4TE Without Rate Control ")
# # getAVGFCTByFolder(folderName= "/home/p4/P4TE/testAndMeasurement/TEST_RESULTS/without-rate-control/WebSearchWorkLoad_load_factor_1/client-logs-0")
# # print("\n\n")
